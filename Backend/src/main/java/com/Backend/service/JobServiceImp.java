...
public class JobServiceImp implements JobService {
    ...
    private List<Country> initCountries(){
        return List.of(
//                new Country("Macau", 667400, 329),
//                new Country("Monaco", 38300, 202),
//                new Country("Singapore", 5638700, 7225),
//                new Country("Hong Kong", 7482500, 1106),
//                new Country("Gibraltar", 33140, 68),
//                new Country("Vatican City", 1000, 044),
//                new Country("Bahrain", 1566993, 778),
//                new Country("Malta", 475701, 315),
//                new Country("Maldives", 378114, 298),
//                new Country("Bermuda", 63779, 52),
//                new Country("Sint Maarten", 40614, 34),
//                new Country("Bangladesh", 166661616, 143998),
//                new Country("Jersey", 104200, 116),
//                new Country("Guernsey", 62723, 78),
//                new Country("State of Palestine", 4816503, 6020),
//                new Country("Mayotte", 256518, 374),
//                new Country("Barbados", 287010, 430),
//                new Country("Collectivity of Saint Martin", 35107, 532),
//                new Country("Taiwan", 23590744, 36197),
//                new Country("Mauritius", 1265577, 2040),
//                new Country("Aruba", 111482, 180),
//                new Country("Lebanon", 6065922, 10452),
//                new Country("San Marino", 33407, 61),
//                new Country("Nauru", 11000, 21),
//                new Country("South Korea", 51811167, 100210),
//                new Country("Rwanda", 12374397, 26338),
//                new Country("Comoros", 873724, 1861),
//                new Country("Saint Barthelemy", 9427, 21),
//                new Country("Curaao", 161573, 36391),
...
//                new Country("Marshall Islands", 55500, 181),
//                new Country("United States Virgin Islands", 104909, 352),
//                new Country("Saint Lucia", 180454, 617),
//                new Country("American Samoa", 56700, 197),
//                new Country("Vietnam", 94660000, 331212),
//                new Country("Saint Vincent and the Grenadines", 110520, 389),
...
//                new Country("Cayman Islands", 63415, 259),
//                new Country("Guadeloupe", 395725, 16284),
...
//                new Country("Northern Cyprus", 351965, 3355),
...
//                new Country("Wallis & Futuna", 11700, 142),
//                new Country("Romania", 19524000, 238391),
//                new Country("Greece", 10741165, 131957),
//                new Country("North Macedonia", 2075301, 25713),
//                new Country("Senegal", 15726037, 196722),
//                new Country("Honduras", 9012229, 112492),
//                new Country("Myanmar", 53862731, 676577),
//                new Country("Ivory Coast", 25823071, 322921),
//                new Country("French Polynesia", 277100, 3521),
//                new Country("Morocco", 35037811, 446550),
//                new Country("East Timor", 1167242, 14919),
//                new Country("Turks and Caicos Islands", 37910, 497),
...
//                new Country("Eswatini", 1159250, 17364),
//                new Country("Bonaire", 18905, 288),
//                new Country("Yemen", 28915284, 455000),
//                new Country("Cook Islands", 15200, 237),
...
//                new Country("Equatorial Guinea", 1222442, 28051),
//                new Country("Guinea-Bissau", 1584763, 36125),
//                new Country("Eritrea", 5187948, 121100),
//                new Country("Lithuania", 2793986, 65300),
//                new Country("Colombia", 45798200, 1141748),
//                new Country("Palau", 17900, 444),
//                new Country("Cocos (Keeling) Islands", 544, 14),
...
//                new Country("Faroe Islands", 50844, 1399),
...
//                new Country("Abkhazia", 243206, 8660),
//                new Country("Laos", 6492400, 236800),
//                new Country("Saint Pierre and Miquelon", 6081, 242),
//                new Country("Peru", 32162184, 1285216),
//                new Country("Vanuatu", 304500, 12281),
//                new Country("Brazil", 209989323, 8515767),
//                new Country("Somalia", 15181925, 637657),
//                new Country("Solomon Islands", 682500, 28370),
...
//                new Country("Belize", 398050, 22965),
...
//                new Country("Christmas Island", 2072, 137),
//                new Country("New Caledonia", 258958, 18575),
//                new Country("Oman", 4183841, 309500),
//                new Country("Saint Helena, Ascension and Tristan da Cunha", 5633, 394),
//                new Country("South Ossetia", 53532, 3900),
//                new Country("Republic of Artsakh", 150932, 11458),
...
//                new Country("Niue", 1613, 261),
                ...
                new Country("Sahrawi Arab Democratic Republic", 567421, 252120),
                new Country("Mongolia", 3000000, 1564100),
                new Country("Pitcairn Islands", 56, 473),
                new Country("Falkland Islands", 2563, 12173),
                new Country("Svalbard and Jan Mayen", 2655, 61399),
    ...
    public List<Country> getItJobOffersInWorld(ModelMap technology) {
        ...
        countries.forEach(country -> {
            ...
            WebClient linkedinURL = WebClient.create("https://pl.linkedin.com/jobs/search?keywords=" + selectedTechnology + "&location=" + selectedCountry);

            switch(selectedTechnology){
                case "it category":
                    linkedinURL = WebClient.create("https://pl.linkedin.com/jobs/search?location=" + selectedCountry + "&pageNum=0&position=1&f_TP=1%2C2%2C3%2C4&f_I=96");
                    break;
                case "c++":
                    linkedinURL = WebClient.create("https://pl.linkedin.com/jobs/c++-jobs-" + selectedCountry);
                    break;
                case "c#":
                    linkedinURL = WebClient.create("https://pl.linkedin.com/jobs/search?keywords=C%23&location=" + selectedCountry);
                    break;
            }
            ...
            country.setDestinyOfPopulation((int) Math.round(country.getPopulation() / country.getAreaSquareKilometers()));
        });
