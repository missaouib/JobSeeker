...
public class MapperService {
    ...
    public PropertyMap<CategoryCityOffers, CategoryDto> categoryCityOffersMapper = new PropertyMap<CategoryCityOffers, CategoryDto>() {
    ...
    public PropertyMap<TechnologyCityOffers, CityDto> technologyCityOffersMapper = new PropertyMap<TechnologyCityOffers, CityDto>() {
        protected void configure() {
    ...
    public PropertyMap<TechnologyCountryOffers, CountryDto> technologyCountryOffersMapper = new PropertyMap<TechnologyCountryOffers, CountryDto>() {
        protected void configure() {
