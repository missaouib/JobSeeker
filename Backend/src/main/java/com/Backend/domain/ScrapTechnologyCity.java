...
class ScrapTechnologyCity {
    ...
    public List<CityDto> loadCitiesStatisticsForTechnology(String technologyName){
        List<TechnologyCityOffers> listOffers = technologyCityOffersRepository.findByDateAndTechnology(LocalDate.now(), technologyRepository.findTechnologyByName(technologyName));
